...
mod1coefs_0 <- round(coef(model_0), 2)
library(knitr)
confint(model_0) %>%
  kable()
```
...
plot_model(model_0, show.values = TRUE, transform = NULL,
           title = "Log-Odds (quality-good)", show.p = FALSE)
```

```{r}
data<- data%>%
      mutate(logodds.good = predict(model_0))
```
...
p1=plot_model(model_0, type = "pred",terms = "aroma" ,title = "Aroma",
            axis.title = c("aroma", "Prob. of quality being good"))
p2=plot_model(model_0, type = "pred", terms="flavor",title = "Flavor",
            axis.title = c("flavor", "Prob. of quality being good"))
p3=plot_model(model_0, type = "pred",terms = "acidity", title = "Acidity",
            axis.title = c("acidity", "Prob. of quality being good"))
p4=plot_model(model_0, type = "pred",terms = "altitude_mean_meters", title = "altitude_mean_meters",
